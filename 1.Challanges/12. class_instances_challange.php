...
<body>
    ...
    /*
        ...
        2. Klasę Home opisującą dom, w której wewnątrz będzie instancja Address. Dodaj dodatkowe właściwiści do Home jak np. ilość pięter itd.
    ...
    */
    ...
    class Home {
        ...
        public function showData() {
            echo($this->address->getData(). " ".$this->numFloors." ".$this->color);
        }
    }
